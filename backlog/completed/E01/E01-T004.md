...
2. **`docs/ARCHITECTURE.md`**
   ...
   - Marked Users as "✅ Implemented (E01-T004)"
   - Added schema location, migration reference, and key fields documentation
   - Added status indicators (✅ Implemented, 🚧 Planned) to all core entities for clarity
...
- ✅ Users table structure and schema definition
- ✅ User status enum values and their meanings
- ✅ Authentication patterns (email/password vs OAuth)
- ✅ Soft delete behavior and query patterns
- ✅ Nullable password_hash rationale
- ✅ Type inference with User and NewUser types
- ✅ Migration tracking (0001_create_users.sql)
