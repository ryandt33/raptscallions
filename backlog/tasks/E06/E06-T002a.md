...
A thoughtfully designed knowledge base improves developer experience and reinforces brand identity. The Modern Agricultural theme establishes Raptscallions' visual language—growth, cultivation, and learning—while ensuring documentation is easy to read and navigate in both light and dark modes.
...
- [x] AC6: Typography uses DM Sans (body) and DM Serif Display (headings) per design system
...
- Logo: Sprout (🌱) with gradient background
