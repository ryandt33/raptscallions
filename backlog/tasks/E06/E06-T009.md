...
- [ ] AC1: testing/index.md provides domain overview and navigation
- [ ] AC2: testing/concepts/vitest-setup.md documents monorepo Vitest configuration
- [ ] AC3: testing/concepts/test-structure.md documents AAA pattern with examples
- [ ] AC4: testing/patterns/mocking.md documents mock patterns and vi.hoisted()
- [ ] AC5: testing/patterns/factories.md documents test data factory patterns
- [ ] AC6: testing/patterns/fastify-testing.md integrates existing Fastify plugin encapsulation docs
- [ ] AC7: testing/patterns/integration-tests.md documents integration test patterns
- [ ] AC8: testing/troubleshooting/common-issues.md documents common test failures
- [ ] AC9: All docs have frontmatter with related_code pointing to actual files
- [ ] AC10: All docs reference implementing tasks (E01-T008, E02-T008, E03-T003, E04-T003)
