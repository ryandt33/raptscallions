...
import { RateLimitError, TimeoutError, AuthenticationError, ModelNotAvailableError, InvalidResponseError, AiError, } from '../errors.js';
...
describe('OpenRouterClient', () => {
    ...
    describe('streamChat', () => {
        ...
        it('should use default model when not specified', async () => {
            ...
            // Assert
            expect(mockCreate).toHaveBeenCalledWith(expect.objectContaining({ model: 'test/model' }), expect.any(Object));
        });
    ...
    describe('edge cases', () => {
        it('should handle empty message array', async () => {
            ...
            // Assert
            expect(mockCreate).toHaveBeenCalledWith(expect.objectContaining({ messages: [] }), expect.any(Object));
        });
        it('should handle multi-turn conversation', async () => {
            ...
            // Assert
            expect(mockCreate).toHaveBeenCalledWith(expect.objectContaining({ messages: mockMessages.conversation }), expect.any(Object));
        });
