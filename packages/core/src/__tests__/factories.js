...
export function createMockCreateUser(overrides = {}) {
    return createMockUser(overrides);
}
// Mock UpdateUser factory (partial user)
export function createMockUpdateUser(overrides = {}) {
    return {
        ...overrides,
    };
}
// Mock CreateGroup factory
export function createMockCreateGroup(overrides = {}) {
    return createMockGroup(overrides);
}
// Mock UpdateGroup factory (partial group)
export function createMockUpdateGroup(overrides = {}) {
    return {
        ...overrides,
    };
}
