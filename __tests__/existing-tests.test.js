...
describe("Existing Tests Compatibility", () => {
    describe("Core Package Tests", () => {
        it("should have errors test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/core/src/__tests__/errors/errors.test.ts");
            // Act
        ...
        it("should have schema composition test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/core/src/__tests__/integration/schema-composition.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have cross-package imports test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/core/src/__tests__/integration/cross-package-imports.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have user schema test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/core/src/__tests__/schemas/user.schema.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have group schema test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/core/src/__tests__/schemas/group.schema.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
    ...
    describe("DB Package Tests", () => {
        it("should have database client test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/db/src/__tests__/client.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have env test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/db/src/__tests__/env.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have users schema test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/db/src/__tests__/schema/users.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have groups schema test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/db/src/__tests__/schema/groups.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have group-members schema test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/db/src/__tests__/schema/group-members.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
        ...
        it("should have types test file", () => {
            // Arrange
            const testPath = resolve(process.cwd(), "packages/db/src/__tests__/schema/types.test.ts");
            // Act
            const exists = existsSync(testPath);
            // Assert
            expect(exists).toBe(true);
    ...
    describe("Test Discovery Patterns", () => {
        it("should discover tests in __tests__ directories", () => {
            // Arrange
            const coreTestsDir = resolve(process.cwd(), "packages/core/src/__tests__");
            // Act
        ...
        it("should discover tests in db package __tests__ directory", () => {
            // Arrange
            const dbTestsDir = resolve(process.cwd(), "packages/db/src/__tests__");
            // Act
...
//# sourceMappingURL=existing-tests.test.js.map